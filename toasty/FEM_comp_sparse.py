...
class FEM(om.ImplicitComponent):
    ...
    def initialize(self):
        ...
        self.options.declare("x_lim", types=Iterable, desc="Lower and upper bounds on x range")
        self.options.declare("y_lim", types=Iterable, desc="Lower and upper bounds on y range")
