...
# USER INPUTS
res = 500
out_folder = os.path.join(cur_dir, f"SAN_{res}_1000K_nosmoo")
...
apt_data = load_airport(airport, resolution, min_density=min_density, ignore_cases=["cargo", "terminal"])
...
if not only_postprocess_video:
    ...
    prob.driver.opt_settings["max_iter"] = 8000
